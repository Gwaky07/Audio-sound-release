---
name: audio-sound
description: 仓库级中文总技能。用于本仓库内的中文口播、课程讲解、配音、旁白、批量音频清理与交付；当用户提到呼吸音、气口、口水音、停顿残留、细丝、响度、电平、频谱图、批量修音、中文文件名保留、Respiro-en、SpectraMini、DeepFilterNet、节点精修、人工参考对照、最终成品命名、只保留最终版时使用。默认按本线程已验证可交付的严格成品标准执行：先走 Respiro-en，再做 SpectraMini 风格清理和 DeepFilterNet，随后完成停顿、细丝、节点精修、响度复核、频谱图验收，并把最终 WAV/MP3 交付到 output/修音成品，命名为 修音版_原名，重名时递增 _01/_02。
---
